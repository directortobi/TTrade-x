...
const CONFIG_DETAILS = {
    Supabase: {
        ...
        message: 'Trade X requires a Supabase connection to handle user authentication and data storage. Without this, the app cannot start.',
        keys: ['VITE_SUPABASE_URL', 'VITE_SUPABASE_ANON_KEY'],
        location: 'Supabase Project Dashboard > Settings > API',
        instructions: 'Add these keys to your "Environment Variables" or "Secrets" settings in your project dashboard.'
    },
    Gemini: {
        title: 'Google Gemini API Key Missing',
        message: 'The technical analysis features of Trade X require a Google Gemini API key to function.',
        keys: ['API_KEY'],
        location: 'Google AI Studio > Get API Key',
        instructions: 'Ensure the environment variable API_KEY is set in your configuration dashboard.'
    }
};
            ...
            <div className="w-full max-w-xl bg-gray-800 border-2 border-red-500/20 rounded-3xl shadow-2xl overflow-hidden animate-fade-in-up">
                ...
                <div className="p-8 space-y-6">
                    ...
                    <div className="flex items-start gap-4 p-4 bg-blue-500/5 rounded-2xl border border-blue-500/10">
                         ...
                         <div>
                            <p className="text-sm font-bold text-white">How to fix this:</p>
