...
import { AgentStatusDisplay } from '../components/compounding/AgentStatusDisplay';
import { CompoundingPlanTable } from '../components/compounding/CompoundingPlanTable';
import { TradeLogTable } from '../components/compounding/TradeLogTable';
    ...
    return (
        <div className="max-w-7xl mx-auto animate-fade-in space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 bg-gray-800/50 p-4 sm:p-6 rounded-2xl border border-gray-700 space-y-6">
                    <div>
