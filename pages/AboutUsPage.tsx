    ...
    return (
        <div className="max-w-4xl mx-auto animate-fade-in text-gray-300">
            <div className="bg-emerald-900/50 p-6 sm:p-8 rounded-2xl border border-green-800 shadow-lg">
                <h1 className="text-3xl sm:text-4xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-teal-400 mb-6">
                    About Trade X
                </h1>
                ...
                <div className="space-y-6 leading-relaxed">
                    ...
                    <h2 className="text-xl sm:text-2xl font-semibold text-teal-300 border-b-2 border-teal-700 pb-2">Our Vision</h2>
                    <p>
                    ...
                    <h2 className="text-xl sm:text-2xl font-semibold text-teal-300 border-b-2 border-teal-700 pb-2">What We Do</h2>
                    <p>
                     ...
                     <h2 className="text-xl sm:text-2xl font-semibold text-teal-300 border-b-2 border-teal-700 pb-2">Our Commitment</h2>
                    <p>
